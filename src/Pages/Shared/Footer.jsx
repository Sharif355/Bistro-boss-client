...
const Footer = () => {
  ...
  return (
    <div>
      <footer className="footer p-10 bg-neutral text-neutral-content items-center justify-center gap-80">
        <aside>
          <p className="text-2xl font-medium text-white"> CONTACT US</p>
